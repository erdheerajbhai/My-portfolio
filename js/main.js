...
(()=>{
  ...
  document.addEventListener("click", (event) =>{
   if(event.target.classList.contains('link-item')){
    //  make sure event.target.hash has a value a before overridding default behavior
     if(event.target.hash !==""){
      ...
      if(navMenu.classList.contains("open")){
        // activate new navigation nemu 'link-item'
...
function popupSlideshow(){
  ...
  // activate loader unti the popupimg loaded
...
window.addEventListener("load", () =>{
  // preloader
  document.querySelector(".preloader").classList.add("fede-out");
  setTimeout(()=>{
